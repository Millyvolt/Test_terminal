/****************************************************************************
** Meta object code from reading C++ file 'packets.h'
**
...
#include <memory>
#include "../../terminal/packets.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'packets.h' doesn't include <QObject>."
...
static const uint qt_meta_data_Packets[] = {
...
const QMetaObject Packets::staticMetaObject = { {
    ...
    qt_meta_stringdata_Packets.offsetsAndSize,
    qt_meta_data_Packets,
    qt_static_metacall,
    nullptr,
...
const QMetaObject *Packets::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *Packets::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_Packets.stringdata0))
