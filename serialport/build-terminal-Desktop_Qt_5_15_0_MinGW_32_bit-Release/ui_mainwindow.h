...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        plainTextEdit_3->setTextInteractionFlags(Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);
        ...
        gridLayout_5->addWidget(checkBox_4, 1, 2, 1, 1);
        ...
        gridLayout_5->addWidget(checkBox_5, 1, 3, 1, 1);
